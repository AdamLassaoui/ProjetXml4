...
<body>
    <nav id="navBar" class="navbar navbar-expand-lg mb-5 navbar-dark">
        <a class="navbar-brand" href="http://projet-php-groupe/1.html">Maçonnerie Ocordo</a>
    ...
    if (!empty($_GET['id']) || isset($_GET['id'])) {
        if (is_numeric($_GET['id'])) {
            if (in_array($_GET['id'], $idControl)) {
                ...
                $error =  'La page recherchée n\'existe pas' . '<img src="assets/img/Sourire-du-plombier-1.jpg" alt="" class="p-5">';
            }
        } else {
            $error =  'La page recherchée n\'existe pas' . '<img src="assets/img/Sourire-du-plombier-1.jpg" alt="" class="p-5">';
        }
